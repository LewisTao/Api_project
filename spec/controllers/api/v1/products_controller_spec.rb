...
describe Api::V1::ProductsController do
	...
	describe 'GET #index' do
		...
		context 'when is not receiving any product ids paramether' do
			before(:each) do
				get :index				
			end
		...
		context 'when product ids parameter is sent' do
			before(:each) do
			...
			it 'returns jsut the products that belong to the user' do
				products_response = json_response[:products]
				products_response.each do |product_response|
	...
	describe 'POST #create' do
		context 'when is successfully created' do
			...
			it 'render the json representation for the product record just created' do
